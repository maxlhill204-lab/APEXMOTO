...
export const metadata: Metadata = {
  ...
  description: "Straightforward APEX MOTO information about the supplied ORZ helmet details, DOT marking, fit, condition and intended use.",
...
export default function SafetyPage() {
  return (
    <div className="page-shell content-page">
      <div className="container page-hero"><p className="eyebrow eyebrow--accent">NO HYPE. JUST WHAT WE KNOW.</p><h1>Ride informed.</h1><p>Trust starts with saying exactly what has—and has not—been documented. The supplied ORZ product image shows a rear DOT FMVSS No. 218 marking. Check the requirements that apply to where you intend to ride.</p></div>
