...
export const products: Product[] = [
  ...
  },
  {
    ...
    slug: "apex-moto-rally-helmet-white-blue",
    name: "APEX MOTO Rally Helmet — White / Blue",
    shortName: "White / Blue Helmet",
    category: "helmet",
    description:
      "The same straightforward APEX MOTO off-road helmet in a white and blue finish. The supplied product information lists an ABS shell, an approximate weight of 1080 g, an extended peak, rear ventilation and a rear DOT FMVSS No. 218 marking. Current availability is limited to Medium and Large.",
    shortDescription: "White and blue off-road helmet with published details and limited local stock.",
    price: 12000,
    images: [
      {
        src: "/products/apex-moto-rally-helmet-white/side.png",
        alt: "White and blue APEX MOTO rally motocross helmet viewed from the side",
        width: 931,
        height: 806,
        colour: "White / Blue",
      },
  ...
  },
  {
    businessId: siteConfig.businessId,
    id: "goggles-orz",
    slug: "apex-moto-mx-goggles",
    name: "APEX MOTO MX Goggles",
    shortName: "APEX MOTO Goggles",
    category: "goggles",
    description:
    ...
    images: [
      {
        src: "/products/apex-moto-mx-goggles/black-gold.png",
        alt: "APEX MOTO motocross goggles with a black frame and yellow-gold mirrored lens",
        width: 951,
        height: 672,
        colour: "Black / Yellow-Gold",
      },
      {
        src: "/products/apex-moto-mx-goggles/red-gold.png",
        alt: "APEX MOTO motocross goggles in the pink and red colourway",
        width: 951,
        height: 677,
        colour: "Pink / Red",
      },
      {
        src: "/products/apex-moto-mx-goggles/grey-ice.png",
        alt: "APEX MOTO motocross goggles with a grey frame and teal mirrored lens",
        width: 953,
        height: 675,
        colour: "Grey / Teal",
      },
      {
        src: "/products/apex-moto-mx-goggles/blue-black.png",
        alt: "APEX MOTO motocross goggles in the blue and black colourway",
        width: 951,
        height: 677,
        colour: "Blue / Black",
      },
      {
        src: "/products/apex-moto-mx-goggles/black-silver.png",
  ...
  },
  {
    ...
    slug: "apex-moto-helmet-goggles-bundle",
    name: "APEX MOTO Helmet + Goggles Bundle",
    shortName: "Helmet + Goggles Bundle",
    category: "bundle",
    description:
      "Choose an available helmet colour and size, add any APEX MOTO goggle colour, and receive the helmet storage bag at no extra cost. It is the full setup at one clear bundle price, with no filler and no prestige markup.",
    shortDescription: "The complete setup at one clear price: helmet, goggles and a free helmet bag.",
    price: 14000,
    images: [
      {
        src: "/products/apex-moto-rally-helmet-black/side.png",
        alt: "Matte black APEX MOTO helmet included in the helmet and goggles bundle",
        width: 939,
        height: 831,
        colour: "Matte Black",
      },
      {
        src: "/products/apex-moto-rally-helmet-white/side.png",
        alt: "White and blue APEX MOTO helmet available in the bundle",
        width: 931,
        height: 806,
        colour: "White / Blue",
      },
      {
        src: "/products/apex-moto-mx-goggles/black-gold.png",
        alt: "Black and yellow-gold APEX MOTO goggles available in the bundle",
        width: 951,
        height: 672,
        colour: "Black / Yellow-Gold",
      },
      {
        src: "/products/apex-moto-mx-goggles/red-gold.png",
        alt: "Pink and red APEX MOTO goggles available in the bundle",
        width: 951,
        height: 677,
        colour: "Pink / Red",
      },
      {
        src: "/products/apex-moto-mx-goggles/grey-ice.png",
        alt: "Grey and teal APEX MOTO goggles available in the bundle",
        width: 953,
        height: 675,
        colour: "Grey / Teal",
      },
      {
        src: "/products/apex-moto-mx-goggles/blue-black.png",
        alt: "Blue and black APEX MOTO goggles available in the bundle",
        width: 951,
        height: 677,
        colour: "Blue / Black",
      },
      ...
      {
        src: "/products/apex-moto-helmet-goggles-bundle/helmet-bag.png",
    ...
    inTheBox: ["APEX MOTO rally helmet", "APEX MOTO MX goggles", "Helmet storage bag — included free"],
